Shader "DGR/sha_waterDown_000"
{
    Properties
    {
		...
		_NoiseValue3 ("NoiseValue3", Range(0,1)) = 0
		_NoiseValue4 ("NoiseValue4", Range(0,1)) = 0
    ...
    SubShader
    {
        ...
        void surf (Input IN, inout SurfaceOutput o)
        {
			...
			float alpha = step(_NoiseValue3, noise.r);
			float outline = step(noise.r, 1 * 1);

			//////////////////////////////////////////////////////

			float alpha2 = step(_NoiseValue4, c.r);
			float outline2 = step(c.r, _NoiseValue4 * 2);
